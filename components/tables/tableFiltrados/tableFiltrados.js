class TableFiltrados extends Table{
    ...
    filtrarProcessos(){
        ...
        this.root.querySelector("caption").innerText = `${processos.length} registros:`
    ...
    attRegistros(qtdt){
        ...
        caption.innerText = `${valores[0] - qtdt} registros 
            ${(valores[0] == undefined || valores[1] == undefined) ? "" : `- ${valores[1]} a ${valores[2] == valores[0] ? valores[0] - qtdt : valores[2]}:`}`
